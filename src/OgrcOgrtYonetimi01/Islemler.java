...
public class Islemler {
    static List<Kisi> ogretmenList = new ArrayList<>();//create edilecek ogrtmen objesi saklayacak bos Kisi data type list tanımlandı
    ...
    private static void ekle() {
        ...
        if (kisiTuru.equalsIgnoreCase("OGRENCI")) {//kisiTuru oğrenci olma  sartı
            ...
            ogretmenList.add(ogrt);//ogrt obj ogrenciList'e eklendi
